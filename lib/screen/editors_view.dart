...
class EditorsView extends StatefulWidget {
  @override
  _EditorsViewState createState() => _EditorsViewState();
}

class _EditorsViewState extends State<EditorsView> {
          ...
          children: [
            ...
            Container(
                ...
                decoration: BoxDecoration(
                  borderRadius: BorderRadius.all(Radius.circular(10)),
                  border: Border.all(
                      width: size.height * .01, color: Colors.blueGrey),
                ),
                child: editorsUrl == ''
  ...
  Future<void> _submitData(FirebaseProvider firebaseProvider) async {
    ...
    Map<String, String> map = {
      'image': imageUrl,
      'category': 'editorsview',
      'date': dateData,
      'id': '123456',
    };
    await firebaseProvider.addEditorsData(map).then((value) {
      if (value) {
        setState(() => _isLoading = false);
        showToast('Success');
      } else {
