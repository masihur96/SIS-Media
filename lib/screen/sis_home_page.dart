...
class SisHomePage extends StatefulWidget {
  const SisHomePage({Key? key}) : super(key: key);

  @override
  _SisHomePageState createState() => _SisHomePageState();
}

class _SisHomePageState extends State<SisHomePage> {
  ...
  customInit(DataProvider dataProvider) async {
    ...
    dataProvider.fetchSubCategoryData();
    ...
    // if (dataProvider.categoryList.isEmpty) {
    //   await dataProvider.fetchCategoryListData().then((value) {
    //     setState(() {
    //       _categoryList = dataProvider.categoryList;
    //       print('List  Counter: $_categoryList');
    //     });
    //   });
    // } else {
    //   setState(() {
                                                        ...
                                                        setState(() {
                                                          ...
                                                          Alert(
                                                            ...
                                                            title:
                                                                "Confirmation Alert",
                                                            desc:
                                                                "All the Data of this Subcategory Will be Deleted . Are you confirm to delete this Subcategory ? ",
                                                            buttons: [
                                                              DialogButton(
                                                                child: Text(
                                                                  "Cancel",
                        ...
                        : TextButton(
                            ...
                            onPressed: () async {
                              ...
                              if (addOrEdit == 'add') {
                                ...
                                print('Selected Category : $collectionValue');
                              }
                            },
                          ),
                  ],
