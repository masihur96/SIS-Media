...
import 'package:media_directory_admin/screen/category/update_print_media_data.dart';
                              ...
                              Container(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Text('Edditor: ${_dataList[index].editor}',style: TextStyle(fontSize: 12,),),
                                          ...
                                          buttons: [
                                            ...
                                            DialogButton(
                                              ...
                                              onPressed: () {
                                                ...
                                                _databaseHelper.deletePrintData(_dataList[index].id, context).then((value){
                                                  if(value==true){
                                                    _getDataFromDatabase();
