...
class TelevisionManagmentAllData extends StatefulWidget {
  const TelevisionManagmentAllData({Key? key}) : super(key: key);

  @override
  _TelevisionManagmentAllDataState createState() =>
      _TelevisionManagmentAllDataState();
}

class _TelevisionManagmentAllDataState
    extends State<TelevisionManagmentAllData> {
  bool _isLoading = false;
  List channels = Variables().getTVManagmentList();
  String channelValue = 'All Television Channel';
